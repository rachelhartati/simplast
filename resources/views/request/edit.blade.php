...
<head>
    ...
    <title>Edit Request - SIMPLAST</title>
            ...
            <div class="content">
                ...
                <div class="table-box">
                    ...
                    <div class="table-header">
                        <h3>Form Edit Request</h3>
                    </div>

                    <form action="{{ route('request.update', $agentRequest->id) }}" method="POST">
    @csrf
    @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="tanggal_request"
                                    value="{{ old('tanggal_request', $agentRequest->tanggal_request) }}" disabled>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Nama Agen</label>
                                <input type="text" class="form-control"
                                    value="{{ old('agent_id', $agentRequest->agent->nama_agent ?? '') }}" disabled>
                                <input type="hidden" name="agent_id"
                                    value="{{ old('agent_id', $agentRequest->agent_id) }}">
                            </div>
                        ...
                        <div class="row g-3">
                                ...
                                <select class="form-select" name="item_id" id="item_id">
                                    ...
                                    @foreach($items as $item)
                                        <option value="{{ $item->id }}" data-stok="{{ $item->stok }}"
                                            {{ old('item_id', $agentRequest->item_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_item }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" placeholder="Masukkan jumlah"
                                    ...
                                    value="{{ old('jumlah_barang', $agentRequest->jumlah_barang) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="total" id="total"
                                    ...
                                    value="{{ old('jumlah_barang', $agentRequest->jumlah_barang) * 25 }}">
