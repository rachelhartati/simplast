...
<head>
    ...
    <title>Edit Distribusi - SIMPLAST</title>
        ...
        <div class="content">
            ...
            <div class="table-box">
                ...
                <div class="table-header">
                    <h3>Edit Distribusi Anggota</h3>
                </div>

                <form action="{{ route('agentstok.update', $job->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $currentUser->agent->nama_agent }}" disabled>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="tanggal_diberikan"
                                value="{{ $job->tanggal_diberikan }}" required>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="item_id" required>
                                ...
                                <option value="{{ $stoks->item->id }}"
                                    {{ $job->item_id == $stoks->item->id ? 'selected' : '' }}>
                                    {{ $stoks->item->nama_item }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="jumlah"
                                ...
                                value="{{ old('jumlah', $job->jumlah) }}" required>
                            @error('jumlah')
