                ...
                <div class="table-box">
                    ...
                    <form action="{{route('agent.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="" style="margin-top: 10px">
                            ...
                            <a href="{{ route('agent.index') }}" class="btn btn-outline-secondary" style="text-decoration: none;">
    Cancel
</a>
                        </div>
                    </form>
