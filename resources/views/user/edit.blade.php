...
<head>
    ...
    <title>Edit User - SIMPLAST</title>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan no telepon"
                                    name="no_tlp" value="{{ old('no_tlp', $user->no_tlp) }}" required>
                            </div>
                                ...
                                <select class="form-select" name="agent_id">
                                    ...
                                    @foreach($agent as $agen)
                                        <option value="{{ $agen->id }}"
                                            {{ old('agent_id', $user->agent_id) == $agen->id ? 'selected' : '' }}>
                                            {{ $agen->nama_agent }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="position:relative;">
                                    <input type="password" class="form-control"
                                        ...
                                        id="passwordInput" style="padding-right:40px;">
                                    <i class="bi bi-eye-slash" id="togglePassword"
                                        onclick="togglePasswordVisibility()"
                                        style="position:absolute;right:12px;top:50%;transform:translateY(-50%);cursor:pointer;color:#888;font-size:18px;"></i>
                                </div>
                            </div>
