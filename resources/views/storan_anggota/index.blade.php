...
<head>
    ...
    <title>Setoran Anggota - SIMPLAST</title>
...
<div class="container">
    ...
    <div class="main" id="main">
        ...
        <div class="content">
            ...
            <div class="title">Setoran Anggota</div>
            <div class="subtitle">Catat dan kelola setoran hasil kerja anggota</div>
            ...
            <div class="card-container">
                ...
                <div class="card">
                    ...
                    <div>
                        <h4>Total Anggota</h4>
                        <h2>{{ $allStoran->pluck('user_id')->unique()->count() }} orang</h2>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div>
                        <h4>Total Setoran</h4>
                        <h2>{{ number_format($allStoran->sum('jumlah_pcs'), 0, ',', '.') }} pcs</h2>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div>
                        <h4>Total Nilai</h4>
                        <h2>Rp {{ number_format($allStoran->sum('total'), 0, ',', '.') }}</h2>
                    </div>
                </div>
            ...
            <form method="GET" action="{{ route('storan-anggota.index') }}" class="filter-box">
                <div class="filter-left">
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="text" name="search" placeholder="Cari nama anggota..."
                            ...
                            style="height:42px;width:230px;border:1px solid #ddd;border-radius:8px;padding:0 14px 0 38px;outline:none;font-size:14px;font-family:'Poppins',sans-serif;">
                    </div>
                    ...
                    <a href="{{ route('storan-anggota.index') }}" class="btn-tambah" style="background:#6c757d;">
                        <i class="bi bi-x-lg"></i> Reset
                    </a>
                    @endif

                </div>
                <a href="{{ route('storan-anggota.create') }}" class="btn-tambah">
            ...
            <div class="table-box">
                ...
                <div class="table-header">
                    <h3>Daftar Setoran Anggota</h3>
                </div>

                <table id="storanTable">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Anggota</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action">
                                    <a href="{{ route('storan-anggota.edit', $stor->id) }}" class="btn-action btn-edit">
                                        Edit
                                    </a>
                                    <form action="{{ route('storan-anggota.destroy', $stor->id) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    <i class="bi bi-send"></i>
                                    <p>Belum ada data setoran anggota</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
...
<script>
    ...
    function filterTable() {
        const anggota = document.getElementById('filterAnggota').value.toLowerCase();
        const bulan   = document.getElementById('filterBulan').value;

        document.querySelectorAll('#storanTable tbody tr').forEach(row => {
            if (!row.dataset.anggota) return;
            const matchAnggota = !anggota || row.dataset.anggota.toLowerCase().includes(anggota);
            const matchBulan   = !bulan   || row.dataset.tanggal === bulan;
            row.style.display  = matchAnggota && matchBulan ? '' : 'none';
        });
    }
