...
<head>
    ...
    <title>Edit Setoran Anggota - SIMPLAST</title>
...
<div class="container">
    ...
    <div class="main" id="main">
        ...
        <div class="content">
            ...
            <div class="title">Edit Setoran Anggota</div>
            <div class="subtitle">Ubah data setoran anggota</div>

            <div class="form-box">

                <div class="form-box-header">
                    <i class="bi bi-pencil-square"></i>
                    <h3>Form Edit Setoran Anggota</h3>
                </div>

                <form action="{{ route('storan-anggota.update', $storan->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-select @error('user_id') is-invalid @enderror"
                                ...
                                <option value="{{ $ang->id }}"
                                        {{ old('user_id', $storan->user_id) == $ang->id ? 'selected' : '' }}>
                                    {{ $ang->nama_lengkap }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                   name="tanggal"
                                   value="{{ old('tanggal', $storan->tanggal) }}" required>
                            @error('tanggal')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-select" name="job_id" id="job_select" required>
                                ...
                                @foreach($agentJobs->where('user_id', $storan->user_id) as $job)
                                <option value="{{ $job['id'] }}"
                                    data-item-id="{{ $job['item_id'] }}"
                                    data-jumlah="{{ $job['jumlah'] }}"
                                    {{ $storan->job_id == $job['id'] ? 'selected' : '' }}>
                                    {{ $job['label'] }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-6">
                            ...
                            @php $selectedJob = $agentJobs->firstWhere('id', $storan->job_id); @endphp
                            <input type="number" class="form-control" id="jumlah_job" readonly
                                value="{{ $selectedJob ? $selectedJob['jumlah'] : '' }}" placeholder="—">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-select @error('item_id') is-invalid @enderror"
                                ...
                                <option value="{{ $item->id }}"
                                        ...
                                        {{ old('item_id', $storan->item_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama_item }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control @error('jumlah_pcs') is-invalid @enderror"
                                   ...
                                   value="{{ old('jumlah_pcs', $storan->jumlah_pcs) }}"
                                   min="1" required>
                            @error('jumlah_pcs')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-6">
                            ...
                            <div class="total-preview">
                                ...
                                <strong id="total_display">Rp {{ number_format($storan->total, 0, ',', '.') }}</strong>
                            </div>
...
<script>
    ...
    // ANGGOTA BERUBAH → ISI ULANG JOB DROPDOWN
    anggotaSelect.addEventListener('change', function () {
        ...
        // unlock item saat anggota berubah
    ...
    // ON LOAD: lock item jika job sudah dipilih
    if (jobSelect.value) {
        itemSelect.disabled = true;
        itemSelect.name = '';
