...
<body>
                ...
                <div class="form-box">
                    ...
                    <form action="{{route('storan.store')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label class="form-label">Total Barang di Request (Karung)</label>
                                <input type="number" class="form-control" id="jumlah_req" readonly placeholder="—">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" name="jumlah_pcs" id="jumlah_pcs"
    ...
    <script>
        ...
        const inputJumlah  = document.getElementById('jumlah_pcs');
        ...
        // AGEN BERUBAH → ISI REQUEST DROPDOWN
