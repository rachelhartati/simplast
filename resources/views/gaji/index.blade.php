...
<head>
    ...
    <title>Rekap Gaji - SIMPLAST</title>
...
<div class="container">
    ...
    <div class="main" id="main">
        ...
        <div class="content">
            ...
            <div class="title">Rekap Gaji</div>
            <div class="subtitle">Riwayat pembayaran gaji Anda</div>
            ...
            <div class="card-container">
                ...
                <div class="card">
                    ...
                    <div>
                        ...
                        <h2>Rp {{ number_format($gaji->sum('total'), 0, ',', '.') }}</h2>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div>
                        <h4>Rata-rata Gaji</h4>
                        <h2>Rp {{ number_format($gaji->avg('total'), 0, ',', '.') }}</h2>
                    </div>
                </div>
                @endif
